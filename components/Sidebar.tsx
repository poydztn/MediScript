      ...
      <div className="p-6 z-10 flex items-center justify-between">
        <button onClick={onSelectDashboard} className="text-left focus:outline-none group">
          <div className="flex items-center gap-3">
             {/* Custom Logo */}
             <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-glow relative overflow-hidden group-hover:scale-105 transition-transform duration-300">

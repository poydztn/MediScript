...
export const specialties: Specialty[] = [
  { id: 'dermato', name: 'Dermatologie', icon: 'Activity', prescriptions: dermatoPrescriptions },
  { id: 'cardio', name: 'Cardiologie', icon: 'Heart', prescriptions: cardioPrescriptions },
  { id: 'gastro', name: 'Gastro-Hépato-Entérologie', icon: 'Stethoscope', prescriptions: gastroPrescriptions },
  { id: 'endocrino', name: 'Diabétologie-Endocrinologie', icon: 'TestTube', prescriptions: endocrinoPrescriptions },
  { id: 'gyneco', name: 'Gynécologie-Obstétrique', icon: 'Baby', prescriptions: gynecoPrescriptions },
  { id: 'infectio', name: 'Infectiologie', icon: 'Bug', prescriptions: infectioPrescriptions },
  { id: 'nephro', name: 'Néphrologie', icon: 'Droplet', prescriptions: nephroPrescriptions },
  { id: 'hemato', name: 'Hématologie', icon: 'Droplet', prescriptions: hematoPrescriptions },
  { id: 'geriatrie', name: 'Gériatrie', icon: 'Users', prescriptions: geriatriePrescriptions },
  { id: 'ophtalmo', name: 'Ophtalmologie', icon: 'Eye', prescriptions: ophtalmoPrescriptions },
  { id: 'neuro', name: 'Neurologie', icon: 'Brain', prescriptions: neuroPrescriptions },
  { id: 'parasito', name: 'Parasitologie', icon: 'Bug', prescriptions: parasitoPrescriptions },
  { id: 'orl', name: 'Oto-Rhino-Laryngologie', icon: 'Ear', prescriptions: orlPrescriptions },
  { id: 'phlebo', name: 'Phlébologie', icon: 'Activity', prescriptions: phleboPrescriptions },
  { id: 'pediatrie', name: 'Pédiatrie', icon: 'Baby', prescriptions: pediatriePrescriptions },
  { id: 'psychiatrie', name: 'Psychiatrie', icon: 'Brain', prescriptions: psychiatriePrescriptions },
  { id: 'pneumo', name: 'Pneumologie', icon: 'Wind', prescriptions: pneumoPrescriptions },
  { id: 'rhumato', name: 'Rhumatologie', icon: 'Bone', prescriptions: rhumatoPrescriptions },
  { id: 'rea', name: 'Réanimation', icon: 'Siren', prescriptions: reaPrescriptions },
  { id: 'urologie', name: 'Urologie', icon: 'Droplet', prescriptions: urologiePrescriptions },
  { id: 'traumato', name: 'Traumatologie', icon: 'Hammer', prescriptions: traumatoPrescriptions },
  { id: 'certificats', name: 'Certificats', icon: 'FileText', prescriptions: certificatsPrescriptions }
];
